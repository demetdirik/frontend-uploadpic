    ...
    >
      ...
      {isMenuActive && (
        <div className="fixed inset-0 lg:static lg:h-full lg:w-full">
          ...
          <div
            className="fixed top-0 bottom-0 left-0 z-50 w-3/4 
          ...
          >
            ...
            <NavItem
              ...
              >
                ...
                <button disabled={isLoadingCreatePost} className="text-start disabled:opacity-60 disabled:cursor-not-allowed" 
